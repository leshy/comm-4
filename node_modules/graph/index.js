...
var GenericGraphNode = Backbone.Model.extend({ 
    ...
    plugs: function () { return _.values(this.plugs) },
...
//        if (!obj) { return }
    ...
    plugremoveall: function(plug,obj) {
        if (plug.constructor == String) { plug = this[plug] }
    ...
    removeall: function () { 
        _.map(this.plugs, function (plug) { this.plugremoveall(plug) }.bind(this))
    }
